...
#[post("/skeleton/api/auth/register")] // required fields : username + email + password + phone_number + device_id 
...
#[post("/skeleton/api/auth/login")] // required fields : username_or_eamil + password
...
#[post("/skeleton/api/auth/check-token")]
