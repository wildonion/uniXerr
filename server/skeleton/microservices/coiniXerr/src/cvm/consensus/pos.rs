...
pub fn can_be_mined(mut block: Block) -> Result<Block, bool>{ //-- define block as mutable cause we want to update its is_mined field
    ...
    // TODO - confirm all valid transactions (mempool) inside a block using a proof of stake consensus algorithm based on uniXerr peers' features and VAE algorithm
