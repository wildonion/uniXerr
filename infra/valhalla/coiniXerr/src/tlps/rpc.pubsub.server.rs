...
pub async fn bootstrap(
    ...
    // TODO - create an emit and msg schema to publish events and logs to the network so client rpc capnp can subscribe to them using addEventListener or a while let Some syntax  
    // TODO - define get_latest_blockhash, get_balance_of and etc ... methods to call them directly from the client using an RPC call to the coiniXerr node  
