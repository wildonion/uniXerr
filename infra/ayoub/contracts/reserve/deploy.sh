...
NEAR_ENV=$NETWORK near deploy --wasmFile out/conse.wasm --accountId $OWNER_ID
...
then
    ...
    NEAR_ENV=$NETWORK near deploy --wasmFile out/conse.wasm --accountId $SUB_MASTER_CONTRACT_ID.$OWNER_ID
fi