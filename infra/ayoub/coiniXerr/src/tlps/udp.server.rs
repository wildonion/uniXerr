...
pub async fn bootstrap(
    ...
    /////// ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈
    ///////          UDP stream to decode incoming transactions using borsh and serde from UDP clients
    /////// ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈ --------- ⚈
    ...
    let udp_addr = env_vars.get("UDP_ADDR").unwrap().as_str();
    ...
    // ----------------------------------------------------------------------
    //                  DEFINING UDP STREAMER MPSC CHANNELS
    // ----------------------------------------------------------------------
