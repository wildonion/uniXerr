...
# TODO - import network models here after they are trained; to create graphql API using tensorflow serving (tfx)
...
# NOTE - todo.ideas to complete uniXerr blog posts, deepkit.ai, tensorboard for visualization to build and complete this project
...
''' resources :
        ...
        http://machinelearningmechanic.com/keras/2019/06/26/keras-serving-keras-model-quickly-with-tensorflow-serving-and-docker-md.html
        https://blog.keras.io/building-a-simple-keras-deep-learning-rest-api.html
        https://blog.tensorflow.org/2018/08/training-and-serving-ml-models-with-tf-keras.html
        https://medium.com/@brianschardt/simple-keras-trained-model-export-for-tensorflow-serving-23fa5dfeeecc
        ...
        https://towardsdatascience.com/publishing-keras-model-api-with-tensorflow-serving-efb5b6d96c36
