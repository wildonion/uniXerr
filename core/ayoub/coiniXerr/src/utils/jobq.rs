...
// ➔ actors use task or job queue channels under the hood like celery which is based on a prod/cons or pub/sub manner to prod tasks and cons tasks from the queue to solve them by sharing them between threads of the worker threadpool using mpsc channel
// ...
